...
> **Everything in this repo runs offline.** No key, no network, no cost, and that
...
(timed sections for guardrails, cache, and the model call, so you see where the time went),
